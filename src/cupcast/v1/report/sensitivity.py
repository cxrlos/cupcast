...
from cupcast.v1.features.squad_strength import normalize_name, squad_composites
from cupcast.v1.sim.monte_carlo import GROUP_LETTERS, TournamentDetails, simulate_tournament
from cupcast.v1.sim.worldcup2026 import ALL_TEAMS, TEAM_GROUP
...
def run_player_scenarios(
    ...
    from cupcast.v1.run import shrunk_fit  # local import to avoid a cycle
